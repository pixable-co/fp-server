...
class DeleteShortcodeCommand extends Command
{
    ...
    {
        $this
            ->setDescription('Delete a PHP shortcode and update class-shortcodes.php.')
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $shortcodeFilePath = $baseDirectory . 'class-shortcodes.php';
        ...
        if (file_exists($shortcodeFilePath)) {
            ...
            $output->writeln("Updated class-shortcodes.php: {$shortcodeFilePath}");
        } else {
            $output->writeln("class-shortcodes.php not found: {$shortcodeFilePath}");
        }
